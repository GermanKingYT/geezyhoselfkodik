	...
	if (is_renderer_active)
	{
		...
		if (g_Options.Menu.iTab == 0)
		{
			...
			if (ImGui::Begin("##tabarea", &is_renderer_active, ImVec2(840, 145), 0.f, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse))
			{
				...
				ImGui::SameLine();
				if (ImGui::Button("I", ImVec2(133.3, 100))) g_Options.Menu.iTab = 2;
				ImGui::SameLine();
				if (ImGui::Button("D", ImVec2(133.3, 100))) g_Options.Menu.iTab = 3;
				ImGui::SameLine();
				if (ImGui::Button("G", ImVec2(133.3, 100))) g_Options.Menu.iTab = 4;
				ImGui::SameLine();
				if (ImGui::Button("B", ImVec2(133.3, 100))) g_Options.Menu.iTab = 5;
				ImGui::SameLine();
				if (ImGui::Button("H", ImVec2(133.3, 100))) g_Options.Menu.iTab = 6;
				ImGui::PopFont();
				...
				if (ImGui::Button("Rage Aimbot", ImVec2(133.3, 42))) g_Options.Menu.iTab = 1;
				ImGui::SameLine();
				if (ImGui::Button("Legit Aimbot", ImVec2(133.3, 42))) g_Options.Menu.iTab = 2;
				ImGui::SameLine();
				if (ImGui::Button("Visuals", ImVec2(133.3, 42))) g_Options.Menu.iTab = 3;
				ImGui::SameLine();
				if (ImGui::Button("Miscellenaous", ImVec2(133.3, 42))) g_Options.Menu.iTab = 4;
				ImGui::SameLine();
				if (ImGui::Button("Skin Changer", ImVec2(133.3, 42))) g_Options.Menu.iTab = 5;
				ImGui::SameLine();
				if (ImGui::Button("Color Selector", ImVec2(133.3, 42))) g_Options.Menu.iTab = 6;
				ImGui::SameLine();
				ImGui::PopFont();
			}ImGui::End();
		}
		...
		else if (g_Options.Menu.iTab == 4)
		{
			...
			if (ImGui::Begin("Misc", &g_Options.Menu.Opened, ImVec2(840, 500), 1.f, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_ShowBorders))
			{
				...
				{
					ImGui::Text("Clantag");
					ImGui::Checkbox("GetRekt Clantag", &g_Options.Misc.syncclantag);
