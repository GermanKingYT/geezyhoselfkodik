...
void misc::OnCreateMove(CInput::CUserCmd *cmd, C_BaseEntity *local)
{
	...
	if (g_Options.Misc.syncclantag)
	{
		...
		switch (value) {
		case 0: setclantag(XorStr("c")); break;
		case 1: setclantag(XorStr("cr")); break;
		case 2: setclantag(XorStr("cra")); break;
		case 3: setclantag(XorStr("crac")); break;
		case 4: setclantag(XorStr("crack")); break;
		case 5: setclantag(XorStr("cracke")); break;
		case 6: setclantag(XorStr("cracked")); break;
		case 7: setclantag(XorStr("cracked.")); break;
		case 8: setclantag(XorStr("cracked.x")); break;
		case 9: setclantag(XorStr("cracked.xy")); break;
		case 10: setclantag(XorStr("cracked.xyz")); break;
		case 11: setclantag(XorStr("cracked.xy")); break;
		case 12: setclantag(XorStr("cracked.x")); break;
		case 13: setclantag(XorStr("cracked.")); break;
		case 14: setclantag(XorStr("cracked")); break;
		case 15: setclantag(XorStr("cracke")); break;
		case 16: setclantag(XorStr("crack")); break;
		case 17: setclantag(XorStr("crac")); break;
		case 18: setclantag(XorStr("cra")); break;
		case 19: setclantag(XorStr("cr")); break;
		case 20: setclantag(XorStr("c")); break;
	...
	if (g_Options.Misc.namespam)
	{
		...
		const char nick[12] = "GetRekt.xyz";
		memcpy(name, nick, 11);
